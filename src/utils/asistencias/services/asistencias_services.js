...
export async function getAsistenciasService(token, curso_id,alumno_id, fecha_desde) {
    return await getAsistenciasCrud(token, curso_id, alumno_id,fecha_desde).then((result) => {
        if (result.success) {
